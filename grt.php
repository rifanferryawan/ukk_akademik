  ...
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('guru_kode','','R','guru_NIP','','R','guru_nama','','R','guru_alamat','','R','guru_telpon','','R');return document.MM_returnValue">
          <table align="center">
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Kode Guru:</td>
              <td><input name="guru_kode" type="text" id="guru_kode" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><input name="guru_NIP" type="text" id="guru_NIP" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Nama:</td>
              <td><input name="guru_nama" type="text" id="guru_nama" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Alamat</td>
              <td><input name="guru_alamat" type="text" id="guru_alamat" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Telepon:</td>
              <td><input name="guru_telpon" type="text" id="guru_telpon" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
