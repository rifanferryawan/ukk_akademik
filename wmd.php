...
$query_dt = sprintf("SELECT * FROM wali_murid left join siswa ON wali_murid.siswa_NISN=siswa.siswa_NISN WHERE wali_id = %s", GetSQLValueString($colname_dt, "text"));
      ...
      <div id="isi">
        ...
        <table width="250" border="0" cellspacing="0">
          ...
          <tr>
            <td>Foto Siswa</td>
            <td>:</td>
            <td><?php echo $row_dt['siswa_foto']; ?></td>
          </tr>
          <tr>
            <td>Nama Ayah</td>
            <td>:</td>
          ...
          <tr>
            ...
            <td>:</td>
            <td><?php echo $row_dt['wali_pekerjaan_ayah']; ?></td>
          </tr>
          <tr>
            <td>Nama Ibu</td>
            <td>:</td>
          ...
          <tr>
            <td>Pekerjaan Ibu</td>
            <td>:</td>
            <td><?php echo $row_dt['wali_pekerjaan_ibu']; ?></td>
          </tr>
          <tr>
            <td>Alamat Wali</td>
            <td>:</td>
