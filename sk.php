...
$query_dt = sprintf("SELECT * FROM standar_kompetensi WHERE sk_nama LIKE %s", GetSQLValueString("%" . $colname_dt . "%", "text"));
  ...
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        ...
        <p><a href="skt.php">Tambah</a></p>
        
    
        <form action="sk.php" method="get" name="form1" class="crf" id="form1">
          <label> pencarian :
          ...
          <table border="1" cellpadding="0" cellspacing="0">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="ske.php?id=<?php echo $row_dt['sk_kode']; ?>">Edit</a> | <a href="skh.php?id=<?php echo $row_dt['sk_kode']; ?>">Hapus</a> | <a href="skd.php?id=<?php echo $row_dt['sk_kode']; ?>">Detail</a></td>
              </tr>
