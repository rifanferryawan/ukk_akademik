        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table align="center">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="guru_kode" value="<?php echo htmlentities($row_dt['guru_kode'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Sk_kode:</td>
              <td><input type="text" name="sk_kode" value="<?php echo htmlentities($row_dt['sk_kode'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Nilai_angka:</td>
              <td><input type="text" name="nilai_angka" value="<?php echo htmlentities($row_dt['nilai_angka'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Nilai_huruf:</td>
              <td><input type="text" name="nilai_huruf" value="<?php echo htmlentities($row_dt['nilai_huruf'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
