...
$query_dt = sprintf("SELECT * FROM guru WHERE guru_nama LIKE %s ORDER BY guru_kode ASC", GetSQLValueString("%" . $colname_dt . "%", "text"));
...
<div id="konten">
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        <h3> Guru</h3>
        <p><a href="grt.php">Tambah</a></p>
        
  
        <form action="gr.php" method="get" name="form1" class="crf" id="form1">
          <label> pencarian :
          ...
          <table border="1" cellpadding="0" cellspacing="0">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="gre.php?id=<?php echo $row_dt['guru_kode']; ?>">Edit</a> | <a href="grh.php?id=<?php echo $row_dt['guru_kode']; ?>">Hapus</a> | <a href="grd.php?id=<?php echo $row_dt['guru_kode']; ?>">Detail</a></td>
              </tr>
