...
mysql_select_db($database_konek, $konek);
$query_dt = sprintf("SELECT * FROM guru WHERE guru_kode = %s", GetSQLValueString($colname_dt, "text"));
  ...
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('guru_NIP','','R','guru_nama','','R','guru_alamat','','R','guru_telpon','','R');return document.MM_returnValue">
          <table align="center">
            <tr valign="baseline">
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><input name="guru_NIP" type="text" id="guru_NIP" value="<?php echo htmlentities($row_dt['guru_NIP'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Nama:</td>
              <td><input name="guru_nama" type="text" id="guru_nama" value="<?php echo htmlentities($row_dt['guru_nama'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Alamat:</td>
              <td><input name="guru_alamat" type="text" id="guru_alamat" value="<?php echo htmlentities($row_dt['guru_alamat'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Telepon:</td>
              <td><input name="guru_telpon" type="text" id="guru_telpon" value="<?php echo htmlentities($row_dt['guru_telpon'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
          ...
          <input type="hidden" name="guru_kode" value="<?php echo $row_dt['guru_kode']; ?>" />
        </form>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    </div>
