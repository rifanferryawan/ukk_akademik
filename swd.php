...
$query_dt = sprintf("SELECT * FROM siswa  left join kompetensi_keahlian  ON siswa.kompetensi_kode=kompetensi_keahlian.kompetensi_kode left join bidang_studi ON kompetensi_keahlian.bidang_kode=bidang_studi.bidang_kode WHERE siswa_NISN = %s", GetSQLValueString($colname_dt, "text"));
      ...
      <div id="isi">
        ...
        <table width="250" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td>:</td>
            <td><?php echo $row_dt['siswa_tgl_lahir']; ?></td>
          </tr>
          <tr>
            <td>Foto</td>
            <td>:</td>
