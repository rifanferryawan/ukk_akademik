...
$query_dt = sprintf("SELECT * FROM kompetensi_keahlian WHERE kompetensi_nama LIKE %s", GetSQLValueString("%" . $colname_dt . "%", "text"));
          ...
          <table border="1" cellpadding="0" cellspacing="0">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="kke.php?id=<?php echo $row_dt['kompetensi_kode']; ?>">Edit</a> | <a href="kkh.php?id=<?php echo $row_dt['kompetensi_kode']; ?>">Hapus</a> | <a href="kkd.php?id=<?php echo $row_dt['kompetensi_kode']; ?>">Detail</a></td>
              </tr>
