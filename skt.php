...
<div id="konten">
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        <h3> Tambah Standar Kompetensi</h3>
        <p>&nbsp;</p>
    
                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('sk_kode','','R','sk_nama','','R','sk_kelas','','R');return document.MM_returnValue">
          <table align="center">
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Kode SK:</td>
              <td><input name="sk_kode" type="text" id="sk_kode" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><input name="sk_nama" type="text" id="sk_nama" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Kelas SK:</td>
              <td><input name="sk_kelas" type="text" id="sk_kelas" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
