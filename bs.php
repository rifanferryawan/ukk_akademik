...
$query_dt = sprintf("SELECT * FROM bidang_studi WHERE bidang_nama LIKE %s", GetSQLValueString("%" . $colname_dt . "%", "text"));
...
<div id="konten">
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        <h3> Bidang Studi</h3>
        <p><a href="bst.php">Tambah</a></p>
        
        
        <form action="bs.php" method="get" name="form1" class="crf" id="form1">
          <label> pencarian :
          ...
          <table border="1" cellpadding="0" cellspacing="0">
            ...
            <?php do { ?>
              <tr>
                ...
                <td><a href="bse.php?id=<?php echo $row_dt['bidang_kode']; ?>">Edit</a> | <a href="bsh.php?id=<?php echo $row_dt['bidang_kode']; ?>">Hapus</a> | <a href="bsd.php?id=<?php echo $row_dt['bidang_kode']; ?>">Detail</a></td>
            </tr>
