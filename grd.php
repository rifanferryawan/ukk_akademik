...
$query_dt = sprintf("SELECT * FROM guru left join kompetensi_keahlian  ON guru.kompetensi_kode=kompetensi_keahlian.kompetensi_kode left join bidang_studi ON kompetensi_keahlian.bidang_kode=bidang_studi.bidang_kode WHERE guru_kode = %s", GetSQLValueString($colname_dt, "text"));
