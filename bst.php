...
<div id="konten">
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        <h3> Tambah Bidang Studi</h3>
        <p>&nbsp;</p>
    
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('bidang_kode','','R','bidang_nama','','R');return document.MM_returnValue">
          <table align="center">
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Kode Bidang:</td>
              <td><input name="bidang_kode" type="text" id="bidang_kode" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Nama Bidang:</td>
              <td><input name="bidang_nama" type="text" id="bidang_nama" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
