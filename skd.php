...
$query_dt = sprintf("SELECT * FROM standar_kompetensi left join kompetensi_keahlian  ON standar_kompetensi.kompetensi_kode=kompetensi_keahlian.kompetensi_kode left join bidang_studi ON kompetensi_keahlian.bidang_kode=bidang_studi.bidang_kode WHERE sk_kode = %s", GetSQLValueString($colname_dt, "text"));
...
<div id="konten">
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        <h3> Detail Standar Kompetensi</h3>
        <table width="250" border="0" cellspacing="0">
          ...
          <tr>
            <td>Nama Standar Kompetensi</td>
            <td>:</td>
            <td><?php echo $row_dt['sk_nama']; ?></td>
          </tr>

          <tr>
            <td>Kelas Standar Kompetensi</td>
            <td>:</td>
            <td><?php echo $row_dt['sk_kelas']; ?></td>
          </tr>
          <tr>
