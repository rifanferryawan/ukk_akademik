...
mysql_select_db($database_konek, $konek);
$query_dt = sprintf("SELECT * FROM kompetensi_keahlian WHERE kompetensi_kode = %s", GetSQLValueString($colname_dt, "text"));
...
$bs = mysql_query($query_bs, $konek) or die(mysql_error());
    ...
    <div id="menu">
      ...
      <div id="isi">
        ...
        <p>&nbsp;</p>
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('kompetensi_nama','','R');return document.MM_returnValue">
          <table align="center">
            <tr valign="baseline">
...
do {  
?>
                  <option value="<?php echo $row_bs['bidang_kode']?>" <?php if (!(strcmp($row_bs['bidang_kode'], htmlentities($row_dt['bidang_kode'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_bs['bidang_kode']?></option>
                  <?php
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><input name="kompetensi_nama" type="text" id="kompetensi_nama" value="<?php echo htmlentities($row_dt['kompetensi_nama'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
          ...
          <input type="hidden" name="kompetensi_kode" value="<?php echo $row_dt['kompetensi_kode']; ?>" />
        </form>
        <p>&nbsp;</p>
    </div>
  </div>
