...
mysql_select_db($database_konek, $konek);
$query_dt = sprintf("SELECT * FROM siswa WHERE siswa_NISN = %s", GetSQLValueString($colname_dt, "text"));
  ...
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('siswa_nama','','R','siswa_alamat','','R','siswa_tgl_lahir','','R','siswa_foto','','R');return document.MM_returnValue">
          <table align="center">
            <tr valign="baseline">
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><input name="siswa_nama" type="text" id="siswa_nama" value="<?php echo htmlentities($row_dt['siswa_nama'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Alamat:</td>
              <td><input name="siswa_alamat" type="text" id="siswa_alamat" value="<?php echo htmlentities($row_dt['siswa_alamat'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Tanggal Lahir<br />
                (YYYY/MM/DD)</td>
              <td><input name="siswa_tgl_lahir" type="text" id="siswa_tgl_lahir" value="<?php echo htmlentities($row_dt['siswa_tgl_lahir'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Foto</td>
              <td><p><img src="img/<?php echo htmlentities($row_dt['siswa_foto'], ENT_COMPAT, 'utf-8'); ?>" width="200px"/>
                </p>
                <p>
                  <input name="siswa_foto" type="text" id="siswa_foto" value="<?php echo htmlentities($row_dt['siswa_foto'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
                </p></td>
            </tr>
            <tr valign="baseline">
          ...
          <input type="hidden" name="siswa_NISN" value="<?php echo $row_dt['siswa_NISN']; ?>" />
        </form>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    </div>
