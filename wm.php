...
$query_dt = sprintf("SELECT * FROM wali_murid WHERE siswa_NISN LIKE %s", GetSQLValueString("%" . $colname_dt . "%", "text"));
...
<div id="konten">
  <div class="isi">
    <div id="menu">
      ...
      <div id="isi">
        <h3> Wali Murid</h3>
        <p><a href="wmt.php">Tambah</a></p>
        
  
        <form action="wm.php" method="get" name="form1" class="crf" id="form1">
          <label> pencarian :
      ...
      <?php if ($totalRows_dt > 0) { // Show if recordset not empty ?>
          <table border="1" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <th>Nama Ibu</th>
              <th>Alamat</th>
              <th class="ket">Telepon</th>
              <th class="ket">Keterangan</th>
            </tr>
            <?php do { ?>
              <tr>
                <td><?php echo $row_dt['siswa_NISN']; ?></td>
                <td><?php echo $row_dt['wali_nama_ayah']; ?></td>
                <td><?php echo $row_dt['wali_nama_ibu']; ?></td>
                <td><?php echo $row_dt['wali_alamat']; ?></td>
                <td><?php echo $row_dt['wali_telpon']; ?></td>
                <td><a href="wme.php?id=<?php echo $row_dt['wali_id']; ?>">Edit</a> | <a href="wmh.php?id=<?php echo $row_dt['wali_id']; ?>">Hapus</a> | <a href="wmd.php?id=<?php echo $row_dt['wali_id']; ?>">Detail</a></td>
            </tr>
